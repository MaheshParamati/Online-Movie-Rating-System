...
<head>
  ...
  <title>Movie Rating System Admin</title>
  <meta charset="utf-8">
...
if ($result->num_rows > 0) {
	...
	echo " <h3>  Movies list</h3> <br>";
	echo "<input class=\"btn btn-warning\" type=\"button\" value=\"Add Movie\" onclick=\"add()\" /><br><br>";
	echo "  <div class=\"row\">";
    while($row = $result->fetch_assoc()) {
      ...
      <div id=\"demo".$i."\" class=\"collapse\">
		...
		<input align=\"left\" class=\"btn btn-warning\" type=\"button\" value=\"Delete\" onclick=\"deletemovie(".$row["movie_id"].")\" />
