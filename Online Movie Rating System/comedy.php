...
$sql = "SELECT * FROM moviestable where category='comedy'";
...
if ($result->num_rows > 0) {
	...
	echo "  <h3> Comedy movies list</h3> <br>";
	echo "  <div class=\"row\">";
	...
	$row1 = $result1->fetch_assoc();
	  ...
	  <label>Rating:".$row1["movie_rating"]."</label>
        <input class=\"form-control\" id=\"name".$row["movie_id"]."\" name=\"Rating\" placeholder=\"Rating(1-10)\" type=\"text\" required><br>
