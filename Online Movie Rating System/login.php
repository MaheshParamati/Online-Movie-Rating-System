		...
		if($user && $password){
			...
			if($numrows==1){
				...
				if($password==$dbpass){
						...
						header('Location: /movierating.php');
...
<h1 align="center">Online Movie Rating System</h1>
  			...
  			<div class="col-md-6 col-md-offset-3">
				...
				<form class="form-horizontal" role="form" method="post" action="#">
					...
					<div class="form-group">
						...
						<div class="col-sm-6 col-sm-offset-2" align="center">
						  <span>  <label for="name" class="col-sm-10 control-label" align="center">Does not have a account yet? Please sign Up here!!</label>
							<a href="sample.php"><input id="submit" name="submit" type="submit" value="Sign Up" class="btn btn-primary"></a></span>
						</div>
						  <br>
<script>
